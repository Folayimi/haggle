...
class ServiceDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final service = Get.arguments as MarketService?;

    if (service == null) {
      return const Scaffold(
        body: Center(child: Text('Service details not available.')),
      );
    }

    final seller = service.seller;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                Expanded(
                  child: HaggleButton(
                    ...
                    onPressed: () {
                      Get.snackbar(
                        'Service requested',
                        'We will notify ${seller.name} that you want to book this service.',
            ...
            Text(
              'Scheduled live for this service',
